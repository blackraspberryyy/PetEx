    ...
    <div class ="container ">
        <div class="card row">
            <nav class = "green darken-3">
                <div class="col s12">
                    <a href="<?= $wholeUrl?>" class="breadcrumb">Reports</a>
                </div>
            </nav>
                    ...
                    <div class="card pink darken-3 ">
                        <div class ="card-content">
                            ...
                            <div class ="row">
                                ...
                                <div class ="col s4">
                                    <i class="fa fa-paw fa-3x white-text"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card blue darken-2">
                        <div class ="card-content">
                            ...
                            <div class ="row">
                                ...
                                <div class ="col s4">
                                    <i class="fa fa-check fa-3x white-text"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card purple darken-3">
                        <div class ="card-content">
                            ...
                            <div class ="row">
                                ...
                                <div class ="col s4">
                                    <i class="fa fa-home fa-3x white-text"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card grey darken-3">
                        <div class ="card-content">
                            ...
                            <div class ="row">
                                ...
                                <div class ="col s4">
                                    <i class="fa fa-question fa-3x white-text"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card yellow darken-3">
                        <div class ="card-content">
                            ...
                            <div class ="row">
                                ...
                                <div class ="col s4">
                                    <i class="fa fa-users fa-3x white-text"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card green darken-3">
                        <div class ="card-content">
                            ...
                            <div class ="row">
                                ...
                                <div class ="col s4">
                                    <i class="fa fa-heart fa-3x white-text"></i>
                                </div>
                            </div>
                        </div>
                    </div>
