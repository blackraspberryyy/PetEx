    ...
    <div id="header-wrapper" class="header-slider">
        <header class="clearfix">
            <div class="logo">
                <img src="<?= $this->config->base_url() ?>images/img/logo-image.png" alt="" />
            </div>
            <div class="container">
                <div class="row">
                    <div class="span12">
            ...
            <div class="row">
                ...
                <div class="span6">
                    <div class="aligncenter">
                        <img src="<?= $this->config->base_url() ?>images/img/icons/creativity.png" alt="" />
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="span2 offset1 flyIn">
                    <div class="people">
                        <img class="team-thumb img-circle" src="<?= $this->config->base_url() ?>images/img/team/img-1.jpg" alt="" />
                        <h3>John Doe</h3>
                        <p>
                            Art director
                        </p>
                ...
                <div class="span2 flyIn">
                    <div class="people">
                        <img class="team-thumb img-circle" src="<?= $this->config->base_url() ?>images/img/team/img-2.jpg" alt="" />
                        <h3>Mike Doe</h3>
                        <p>
                            Web developer
                        </p>
                ...
                <div class="span2 flyIn">
                    <div class="people">
                        <img class="team-thumb img-circle" src="<?= $this->config->base_url() ?>images/img/team/img-3.jpg" alt="" />
                        <h3>Neil Doe</h3>
                        <p>
                            Web designer
                        </p>
                ...
                <div class="span2 flyIn">
                    <div class="people">
                        <img class="team-thumb img-circle" src="<?= $this->config->base_url() ?>images/img/team/img-4.jpg" alt="" />
                        <h3>Mark Joe</h3>
                        <p>
                            UI designer
                        </p>
                ...
                <div class="span2 flyIn">
                    <div class="people">
                        <img class="team-thumb img-circle" src="<?= $this->config->base_url() ?>images/img/team/img-5.jpg" alt="" />
                        <h3>Stephen B</h3>
                        <p>
                            Digital imaging
                        </p>
